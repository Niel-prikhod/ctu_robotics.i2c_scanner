...
void SSD1306_send_cmd(uint8_t cmd) {
	...
	    i2c_write_blocking(I2C_DP_PORT, SSD1306_I2C_ADDR, buf, 2, false);
}
...
void SSD1306_send_buf(uint8_t buf[], int buflen) {
	...
	    i2c_write_blocking(I2C_DP_PORT, SSD1306_I2C_ADDR, temp_buf, buflen + 1, false);
	    free(temp_buf);
}
...
int write_to_disp(char **text) {
	...
	    gpio_set_function(I2C_DP_SDA, GPIO_FUNC_I2C);
	    gpio_set_function(I2C_DP_SCL, GPIO_FUNC_I2C);
	    gpio_pull_up(I2C_DP_SDA);
	    gpio_pull_up(I2C_DP_SCL);
	    SSD1306_init();
